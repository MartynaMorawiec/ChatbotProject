...
const Footer = () => {
  return (
    <footer className="absolute bottom-0 w-full flex justify-between items-center h-[80px] px-8 bg-white">
      ...
      <button className="flex justify-center items-center w-[3.5em] h-[3.5em] ml-2 mr-2 mb-7 sm:w-[4em] sm:h-[4em] mt-[1em] bg-secondary hover:bg-primary text-white text-sm rounded-full shadow-blue">
